...
'''
 ...
 Но вместо индекса родительской вершины в листе, кладем каждого родитя в ключ словаря
...
class Graph():
    ...
    # метод, генерурующий полный граф из нулевой вершины
    @classmethod
    def create_from_node(self, node: Node, generator: GenerateNode, charge: Charge):
